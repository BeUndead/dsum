...
/**
 * The ext.CompoundIcon will paint two, or more, Icons as a single Icon. The
...
public class CompoundIcon implements Icon {
    ...
    /**
     * Convenience contructor for creating a ext.CompoundIcon where the
     * icons are layed out on on the X-AXIS, the gap is 0 and the
     * X/Y alignments will default to CENTER.
     *
     * @param icons the Icons to be painted as part of the ext.CompoundIcon
     */
    ...
    /**
     * Create a ext.CompoundIcon specifying all the properties.
     *
     * @param axis       the axis used to lay out the icons for painting
     *                   Must be one of the Axis enums: X_AXIS, Y_AXIS, Z_Axis.
     * @param gap        the gap between the icons
    ...
    /**
     * Get the number of Icons contained in this ext.CompoundIcon.
     *
     ...
     * @param component the component which is displaying the ext.CompoundIcon
    ...
    /*
     *	Determine the bounds of each Icon contained within the ext.CompoundIcon
     */
     ...
     *  ext.CompoundIcon. The bounds will always be returned for the specified
     ...
     */
    record IconInfo(Icon icon, Rectangle bounds, Point point) {
    }
}
